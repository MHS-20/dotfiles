...
## Never reference the plan/todo

Never mention a plan file, todo file, phase number, or item number in docs — write for someone reading the finished thing, not the process behind it.
