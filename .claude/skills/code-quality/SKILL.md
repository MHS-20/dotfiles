...
- **Never reference a plan/todo file, phase number, or item number in a comment.** Comments describe the code as it is, not the process that produced it.
...
Report completion in a few words, not a wall of text — the diff already shows the work.
