...
- Never add a co-author line (e.g. `Co-Authored-By: Claude...`) to any commit. Not once, no exceptions.
- Never reference a plan/todo file, phase number, or item number in a commit message.
