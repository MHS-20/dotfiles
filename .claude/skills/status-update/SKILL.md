...
Keep this short — a few lines, not an essay. The plan/todo itself stays brief and minimal, bullet points, no padding — not a lot of text.

Never reference plan or todo files, phase numbers, or item numbers in commit messages, docs, or code comments — anywhere outside this conversation. They're working scaffolding, not part of the artifact.
...
Close out every non-trivial task with, in a few short lines — not a wall of text:
